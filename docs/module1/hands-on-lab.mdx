...
## 📝 Exercise 1: Build a Simple Humanoid Controller
...
## 📝 Exercise 2: AI-Based Gait Planning
...
class GaitPlanner(Node):
    ...
    def command_callback(self, msg):
        ...
        self.get_logger().info(f'Command received: {command} → State: {self.gait_state}')
...
## 📝 Exercise 3: Vision-Based Object Tracking
...
- ✅ Create a complete ROS 2 workspace
- ✅ Define a humanoid robot in URDF
- ✅ Implement balance control
- ✅ Plan walking gaits
- ✅ Track objects with vision
- ✅ Integrate multiple nodes into a system
...
**Next Module**: [Module 2: The Digital Twin →](../module2/index)
